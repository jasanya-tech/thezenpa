...
class CreateTbmFpxPaymentb2bAcTable extends Migration
{
    public function up()
    {
        Schema::create('tbm_fpx_paymentb2b_ac', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbm_fpx_paymentb2b_ac');
    }
}
